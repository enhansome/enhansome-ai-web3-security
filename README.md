...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,159 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-09 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
...
* [forefy/.context](https://github.com/forefy/.context) ⭐ 147 | 🐛 0 | 🌐 Python | 📅 2026-09-09 (Skill) - AI agent security audit skills producing triaged, industry-grade reports. Supports Solidity, Anchor/Rust, Vyper, FunC/Tact, and Sui Move.
...
* [pashov/ai-web3-security](https://github.com/pashov/ai-web3-security) ⭐ 546 | 🐛 1 | 📅 2026-09-18 - AI Web3 security tools/skills/agents, constantly updated.
