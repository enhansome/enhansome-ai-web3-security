...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,069 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-09 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
...
* [forefy/.context](https://github.com/forefy/.context) ⭐ 127 | 🐛 0 | 🌐 Python | 📅 2026-08-11 (Skill) - AI agent security audit skills producing triaged, industry-grade reports. Supports Solidity, Anchor/Rust, Vyper, FunC/Tact, and Sui Move.
...
* [Trail of Bits Skills](https://github.com/trailofbits/skills) ⭐ 6,564 | 🐛 37 | 🌐 Python | 📅 2026-08-12 - Plugin marketplace for Claude Code and Codex with 35 plugins spanning smart contract security (6-blockchain vulnerability scanning, entry-point analysis), code auditing (differential review, variant analysis), reverse engineering, and more.
...
* [QuillAudits Claude Skills](https://github.com/quillai-network/qs_skills) ⭐ 118 | 🐛 1 | 🌐 Shell | 📅 2026-03-30 - 10 specialized skills covering OWASP Smart Contract Top 10: behavioral state analysis, adversarial simulation, invariant inference, Bayesian scoring.
...
* [EVMbench](https://github.com/paradigmxyz/evmbench) ⭐ 446 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-24 - Benchmark and agent harness for finding and exploiting smart contract bugs. Companion to OpenAI's evmbench detect evaluation. ([Paper](https://arxiv.org/html/2603.04915v1))
...
* [pashov/ai-web3-security](https://github.com/pashov/ai-web3-security) ⭐ 483 | 🐛 3 | 📅 2026-08-10 - AI Web3 security tools/skills/agents, constantly updated.
