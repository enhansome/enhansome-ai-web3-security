...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,206 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-23 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
* [Hound](https://github.com/scabench-org/hound) ⭐ 817 | 🐛 16 | 🌐 Python | 📅 2026-09-17 (CLI) - Language-agnostic AI auditor that autonomously builds and refines adaptive knowledge graphs for deep, iterative code reasoning.
...
* [Trail of Bits Skills](https://github.com/trailofbits/skills) ⭐ 7,252 | 🐛 49 | 🌐 Python | 📅 2026-09-25 - Plugin marketplace for Claude Code and Codex with 35 plugins spanning smart contract security (6-blockchain vulnerability scanning, entry-point analysis), code auditing (differential review, variant analysis), reverse engineering, and more.
...
* [pashov/ai-web3-security](https://github.com/pashov/ai-web3-security) ⭐ 550 | 🐛 2 | 📅 2026-09-18 - AI Web3 security tools/skills/agents, constantly updated.
