...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,094 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-09 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
...
* [forefy/.context](https://github.com/forefy/.context) ⭐ 133 | 🐛 0 | 🌐 Python | 📅 2026-08-24 (Skill) - AI agent security audit skills producing triaged, industry-grade reports. Supports Solidity, Anchor/Rust, Vyper, FunC/Tact, and Sui Move.
...
* [ZeroSkills](https://github.com/zerocoolailabs/ZeroSkills) ⭐ 50 | 🐛 1 | 📅 2026-08-11 - Zero-shot vulnerability detector targeting bugs outside the model's training distribution. Currently includes Slot Sleuth, an EVM storage-safety scanner.
* [CD Security's AUDIT-PREP](https://github.com/CDSecurity/cdsecurity-skills) ⭐ 45 | 🐛 0 | 🌐 Shell | 📅 2026-04-08 - Eight-phase parallel Solidity pre-audit checker that runs inside Claude Code to surface hygiene issues, missing tests, and documentation gaps before formal review.
...
* [SmartBugs](https://github.com/smartbugs/smartbugs) ⭐ 683 | 🐛 3 | 🌐 Python | 📅 2026-05-20 - Framework integrating 20+ analysis tools with SB Curated (143 contracts, 208 vulnerabilities), SB Wild (47,398 contracts), and SolidiFI (9,369 injected bugs). Widely used in ML research.
