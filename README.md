...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,098 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-09 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
...
* [Trail of Bits Skills](https://github.com/trailofbits/skills) ⭐ 6,876 | 🐛 25 | 🌐 Python | 📅 2026-08-27 - Plugin marketplace for Claude Code and Codex with 35 plugins spanning smart contract security (6-blockchain vulnerability scanning, entry-point analysis), code auditing (differential review, variant analysis), reverse engineering, and more.
* [Certora Prover + AI Composer](https://github.com/Certora/CertoraProver) ⭐ 328 | 🐛 44 | 🌐 Kotlin | 📅 2026-08-25 - State-of-the-art formal verification prover. AI Composer helps generate CVL specifications using LLMs.
...
* [ZeroSkills](https://github.com/zerocoolailabs/ZeroSkills) ⭐ 53 | 🐛 1 | 📅 2026-08-11 - Zero-shot vulnerability detector targeting bugs outside the model's training distribution. Currently includes Slot Sleuth, an EVM storage-safety scanner.
