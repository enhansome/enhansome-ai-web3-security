...
* [Pashov Audit Group Skills](https://github.com/pashov/skills) ⭐ 1,193 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-23 (Skill) - Fast (\~5 min) Solidity security feedback during development. Built by Pashov Audit Group.
...
* [Trail of Bits Skills](https://github.com/trailofbits/skills) ⭐ 7,224 | 🐛 41 | 🌐 Python | 📅 2026-09-23 - Plugin marketplace for Claude Code and Codex with 35 plugins spanning smart contract security (6-blockchain vulnerability scanning, entry-point analysis), code auditing (differential review, variant analysis), reverse engineering, and more.
